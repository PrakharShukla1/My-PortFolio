...
export default function Projects() {
  ...
  const projects = [
    {
      id: 'SYS.01',
      title: 'Nexus Event Matrix',
      subtitle: 'Full-Stack Event Booking Platform',
      description: 'A scalable event discovery and booking platform featuring real-time ticketing, user authentication, and secure payment gateways.',
    ...
    {
      id: 'SYS.02',
      title: 'Aegis Infra Portal',
      subtitle: 'Civil Construction Corporate Site',
      description: 'A high-performance corporate portfolio and project management dashboard engineered for a large-scale civil construction firm.',
    ...
    },
    {
      id: 'SYS.03',
      title: 'Vitality Core',
      subtitle: 'Physiology & Healthcare System',
      description: 'A dedicated patient management, physiology tracking, and appointment scheduling system for healthcare professionals.',
      stack: 'MERN Stack • JWT Auth • REST APIs',
            ...
            >
              ...
              <div style={styles.cardBody}>
                ...
                <div style={styles.imagePlaceholder}>
                  <p style={styles.placeholderText}>AWAITING VISUAL DATA</p>
                </div>
              ...
              <div style={styles.cardFooter}>
                ...
                <button style={{ ...styles.actionBtn, borderColor: project.accentColor, color: project.accentColor }}>
                  REPO LOCKED 🔒
                </button>
              </div>
            </div>
